...
COLOR_MAP = {
    ...
    (192, 192, 192): ("светло-серый", "light-gray"),
    (64, 64, 64): ("тёмно-серый", "dark-gray"),
    ...
    (245, 245, 220): ("бежевый", "beige"),
    (0, 128, 128): ("бирюзовый", "teal"),
    (128, 0, 0): ("бордовый", "maroon"),
    (0, 0, 128): ("тёмно-синий", "navy"),
    (128, 128, 0): ("оливковый", "olive"),
    (255, 215, 0): ("золотой", "gold"),
    (192, 192, 192): ("серебряный", "silver"),
    (245, 245, 245): ("кремовый", "cream"),
    (139, 69, 19): ("шоколадный", "chocolate"),
    (47, 79, 79): ("графитовый", "charcoal"),
}
