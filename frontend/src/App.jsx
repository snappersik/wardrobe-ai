...
import StatsPage from './pages/StatsPage'             // Статистика гардероба (Premium)
...
import AdminMLPage from './pages/admin/AdminMLPage'               // ML обучение
    ...
    return (
        ...
        <ErrorBoundary>
            ...
            <Routes>
                ...
                <Route path="/stats" element={<ProtectedRoute><AuthLayout><StatsPage /></AuthLayout></ProtectedRoute>} />
                ...
                <Route path="/admin/ml" element={<AdminRoute><AdminMLPage /></AdminRoute>} />
