...
const HowItWorks = () => {
  ...
  return (
    <section id="how-it-works" className="section-padding" data-name="HowItWorks" data-file="components/HowItWorks.js">
            ...
            <div className="space-y-10">
              {steps.map((step, idx) => (
                <div key={idx} className="flex gap-6">
                  <div className="flex-shrink-0 w-12 h-12 rounded-full border-2 border-[var(--primary-color)] flex items-center justify-center text-[var(--primary-color)] font-bold text-lg">
                    {step.num}
                  </div>
                  <div>
